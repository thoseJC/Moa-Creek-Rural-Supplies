...
INSERT INTO users (user_id, role_id, first_name, last_name, username,  email,phone_number, user_password, status) 
VALUES 
    (UUID(), (SELECT role_id FROM user_roles WHERE role_name = 'manager'), 'Monica', 'Briggs', 'manager', 'manager@manager.com','02108840355' , 'cf084719165ebe921d17d10804f520994a9f9d6d702871e1cc6337cff1e20203', TRUE),
    (UUID(), (SELECT role_id FROM user_roles WHERE role_name = 'customer'), 'Forrest', 'Curtis', 'customer', 'kevin.li@lincolnuni.ac.nz','02108840355' , 'cf084719165ebe921d17d10804f520994a9f9d6d702871e1cc6337cff1e20203', TRUE),
    (UUID(), (SELECT role_id FROM user_roles WHERE role_name = 'admin'), 'Basil', 'Parker', 'admin', 'admin@admin.com','02108840355' , 'cf084719165ebe921d17d10804f520994a9f9d6d702871e1cc6337cff1e20203', TRUE),
    (UUID(), (SELECT role_id FROM user_roles WHERE role_name = 'staff'), 'Harley', 'Stephenson', 'staff', 'staff@staff.com','02108840355' , 'cf084719165ebe921d17d10804f520994a9f9d6d702871e1cc6337cff1e20203', TRUE),
    (UUID(), (SELECT role_id FROM user_roles WHERE role_name = 'manager'), 'Alice', 'Johnson', 'alice', 'alice@manager.com','02108840355' , 'cf084719165ebe921d17d10804f520994a9f9d6d702871e1cc6337cff1e20203', TRUE),
    (UUID(), (SELECT role_id FROM user_roles WHERE role_name = 'customer'), 'Bob', 'Smith', 'bob', 'bob@customer.com','02108840355' , 'cf084719165ebe921d17d10804f520994a9f9d6d702871e1cc6337cff1e20203', TRUE),
    (UUID(), (SELECT role_id FROM user_roles WHERE role_name = 'staff'), 'Charlie', 'Brown', 'charlie', 'charlie@staff.com','02108840355' , 'cf084719165ebe921d17d10804f520994a9f9d6d702871e1cc6337cff1e20203', TRUE),
    (UUID(), (SELECT role_id FROM user_roles WHERE role_name = 'staff'), 'David', 'Wilson', 'david', 'david@staff.com', '02108840355' ,'cf084719165ebe921d17d10804f520994a9f9d6d702871e1cc6337cff1e20203', TRUE),
    (UUID(), (SELECT role_id FROM user_roles WHERE role_name = 'customer'), 'Eva', 'Taylor', 'eva', 'eva@customer.com','02108840355' , 'cf084719165ebe921d17d10804f520994a9f9d6d702871e1cc6337cff1e20203', TRUE);
...
INSERT INTO categories (name, parent_id, description, ct_image_path, active)
VALUES
('Vaccines', @animal_health_care_id, 'Vaccines to prevent diseases in animals.', 'images/products/vacine.jpg', TRUE),
('Antibiotics', @animal_health_care_id, 'Antibiotics to treat animal diseases.', 'images/products/milkogen.png', TRUE),
('Supplements', @animal_health_care_id, 'Supplements to enhance animal health.', 'images/category_image/supplements.jpg', TRUE),
('Poultry Feed', @animal_feed_nutrition_id, 'Feed for poultry.', 'images/products/poultryfeed.jpg', TRUE),
('Cattle Feed', @animal_feed_nutrition_id, 'Feed for cattle.', 'images/category_image/Cattle Feed.jpg', TRUE),
('Pet Food', @animal_feed_nutrition_id, 'Food for pets.', 'images/category_image/Pet Food.jpg', TRUE),
('Feeding Equipment', @animal_equipment_id, 'Equipment used for feeding livestock.', 'images/category_image/Cattle Feed.jpg', TRUE),
('Milking Equipment', @animal_equipment_id, 'Equipment used for milking livestock.', 'images/category_image/Milking Equipment.jpg', TRUE),
('Pest Control', @agrichemicals_id, 'Products to control pests in crops.', 'images/category_image/Pest Control.jpg', TRUE),
('Herbicides', @agrichemicals_id, 'Chemical products to control unwanted plants.', 'images/category_image/Herbicides.jpg', TRUE),
('Fungicides', @agrichemicals_id, 'Chemical products to control fungi.', 'images/category_image/Fungicides.webp', TRUE);
...
Reduces the risk of milk fever by increasing the levels of calcium in the blood.', 15.00, 'Calcitop-new-web.png', 1),
       ...
       ((SELECT category_id FROM categories WHERE name = 'Vaccines'), 'Animal Vaccine',
        'A vaccine to prevent diseases in animals.jpeg', 30.00, 'Animal Vaccine.jpg', 1),
       ...
       ((SELECT category_id FROM categories WHERE name = 'Supplements'), 'Animal Supplement',
        'A supplement to enhance animal health.jpeg', 25.00, 'Supplements.png', 1),
       ((SELECT category_id FROM categories WHERE name = 'Poultry Feed'), 'Poultry Feed', 'Feed for poultry.', 15.00,
        'Poultry Feed.png', 1),
       ((SELECT category_id FROM categories WHERE name = 'Cattle Feed'), 'Cattle Feed', 'Feed for cattle.', 18.00, 'Cattle Feed.jpg',
        1),
       ((SELECT category_id FROM categories WHERE name = 'Pet Food'), 'Pet Food', 'Food for pets.', 22.00, 'Pet Food.jpg', 1),
       ((SELECT category_id FROM categories WHERE name = 'Feeding Equipment'), 'Feeder',
        'Equipment used for feeding livestock.jpeg', 50.00, 'Feeding Equipment.webp', 1),
       ((SELECT category_id FROM categories WHERE name = 'Milking Equipment'), 'Milking Machine',
        'Equipment used for milking livestock.jpeg', 120.00, 'Milking Equipment.webp', 1),
       ((SELECT category_id FROM categories WHERE name = 'Pest Control'), 'Pest Control Spray',
        'Products to control pests in crops.jpeg', 25.00, 'Pest Control.jpg', 1),
       ((SELECT category_id FROM categories WHERE name = 'Herbicides'), 'Herbicide',
        'Chemical products to control unwanted plants.', 15.00, 'Herbicides.jpeg', 1),
       ((SELECT category_id FROM categories WHERE name = 'Fungicides'), 'Fungicide','Chemical products to control fungi.', 20.00, 'Fungicides.jpg', 1),
