...
from auth import hashPassword, getSalt, checkHashingValue  # Assuming you want these active
from cursor import getCursor
from validation is_valid_email, is_valid_phone_number

from manager import manager_page
from customer import customer_page
from admin import admin_page
from staff is staff_page

app = Flask(__name__)

# Register all necessary blueprints with their prefixes
